    ...
    Tables: {
      ...
      Expense: {
        Row: {
          ...
          organizer_id: string | null
          payment_method:
            | Database["public"]["Enums"]["ExpensePaymentMethod"]
            | null
          property_id: string
      ...
      ExpenseStream: {
        Row: {
          ...
          frequency:
            | Database["public"]["Enums"]["ExpenseStreamFrequency"]
            | null
          id: string
      ...
      Property: {
        ...
        Insert: {
          ...
          type?: Database["public"]["Enums"]["PropertyType"] | null
          unit_of_mesure?:
            | Database["public"]["Enums"]["UnitOfMesureType"]
            | null
          updated_at?: string
          user_relationship?: string | null
          year_built?: string | null
      ...
      User: {
        Row: {
          active_calendar_provider:
            | Database["public"]["Enums"]["ProviderType"]
            | null
